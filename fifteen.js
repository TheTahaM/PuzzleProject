  ...
  if (document.readyState == "complete") {
	...
	function gameWon() {
      ...
      document.getElementById("gameWon").innerHTML = "<div>" +
        "<img onClick='location.reload();' src='puzzlePic.jpg'/></div><br/><h1 class='gameWon' onClick='location.reload();'>Congratulation! You WON!</h1><br/><img src='won.gif'/>";
    }
    ...
    document.getElementById("overall").outerHTML= "";
      document.getElementById("gameLost").innerHTML = "<div>" +
        "<img onClick='location.reload();' src='puzzlePic.jpg'/></div><br/><h1 class='gameLost' onClick='location.reload();'>You ran out of time please try again </h1><br/><img src='defeat.gif'/>";
    }
