  ...
  if (document.readyState == "complete") {
	...
	function celebrate() {
      ...
      document.getElementById("celebrate").innerHTML = "<div>" +
        "<img onClick='location.reload();' src='puzzlePic.jpg'/></div><br/><h1 class='celebrate' onClick='location.reload();'>Congratulation! You WON!</h1><br/><img src='won.gif'/>";
    }
  
	function defeat() {
      alert("You ran out of time please try again.");
    document.getElementById("overall").outerHTML= "";
      document.getElementById("defeat").innerHTML = "<div>" +
        "<img onClick='location.reload();' src='puzzlePic.jpg'/></div><br/><h1 class='defeat' onClick='location.reload();'>You ran out of time please try again </h1><br/><img src='defeat.gif'/>";
    }
